<?php
    ...
    $rqt="SELECT COUNT(id_dec) as nbre_deces FROM tdeces";
        $result1=mysqli_query($base,$rqt) OR die(mysql_error());
        if(mysqli_num_rows($result1)==1){
            $data1=mysqli_fetch_assoc($result1);
            $nbre_deces=$data1['nbre_deces'];
            }else
            {
                $nbre_deces=0;
            }
...
<head>
    ...
    <title>Notre page d'accueil</title>
	<!-- BOOTSTRAP STYLES-->
...
?> &nbsp; <a href="deconnexion.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <!-- /. ROW  -->
                  <hr />
                  <!-- read data for -naissance- into database -->
                  <?php 
        $rq="SELECT COUNT(id_naiss) as nbre_naiss FROM tnaissance";
        $result=mysqli_query($base,$rq) OR die(mysql_error());
        if(mysqli_num_rows($result)==1){
            $data=mysqli_fetch_assoc($result);
            $nbre_naiss=$data['nbre_naiss'];
            }else
            {
                $nbre_naiss=0;
            }
 ?>
            ...
            <div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $nbre_naiss; ?> Naissances</p>
                    <p class="text-muted">Enregistrées</p>
                </div>
             </div>
             </div>
                <div class="col-md-3 col-sm-6 col-xs-6">           
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $nbre_deces ; ?> décès</p>
                    <p class="text-muted">Enregistrés</p>
                </div>
             </div>
		     </div>
                    <?php 
        $rq="SELECT COUNT(id_naiss) as nbre_naiss FROM tnaissance WHERE age_mere_naiss<18";
        $result=mysqli_query($base,$rq) OR die(mysql_error());
        if(mysqli_num_rows($result)==1){
            $data=mysqli_fetch_assoc($result);
            $nbre_naiss_min=$data['nbre_naiss'];
            }else
            {
                $nbre_naiss_min=0;
            }
 ?>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo $nbre_naiss_min; ?> Naiss/mere -18</p>
                    <p class="text-muted">Enregistrées</p>
                </div>
             </div>
		     </div>
<?php 
        $rqmort="SELECT COUNT(id_cause_dec) as nbre_maladie_mort FROM tdeces";
        $resultmort=mysqli_query($base,$rqmort) OR die(mysql_error());
        if(mysqli_num_rows($resultmort)==1){
            $datamort=mysqli_fetch_assoc($resultmort);
            $nbre_maladie_mort=$datamort['nbre_maladie_mort'];
            }else
            {
                $nbre_maladie_mort=0;
            }
 ?>
              <?php 
        $rq="SELECT COUNT(id_cause) as nbre_maladie FROM tcause";
        $result=mysqli_query($base,$rq) OR die(mysql_error());
        if(mysqli_num_rows($result)==1){
            $data=mysqli_fetch_assoc($result);
            $nbre_maladie=$data['nbre_maladie'];
            }else
            {
                $nbre_maladie=0;
            }
 ?>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text"><?php echo "+".$nbre_maladie_mort."/".$nbre_maladie; ?> Maladies</p>
                    <p class="text-muted">Mortel</p>
                </div>
             </div>
		     </div>
			</div>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">52 Importantes Informations à savoir </p>
                    <p class="text-muted">Suivez très bien les conseils medicaux pour votre santé</p>
          ...
          <div class="main-temp-back">
            <div class="panel-body">
              <div class="row">
                <div class="col-xs-6"> <i class="fa fa-cloud fa-3x"></i> GOMA town </div>
                <div class="col-xs-6">
