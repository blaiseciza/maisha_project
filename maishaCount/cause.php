                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Form Causes-maladies
                        </div>
                    <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" action="process_cause.php" method="POST">
                                    <input type="hidden" name="id_update_cause" value="<?php echo $id_update_cause; ?>">
                                        
                                        <div class="form-group">
                                            <input class="form-control" name="designation_cause" value="<?php echo $designation_cause; ?>" placeholder="Entrer la designation" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="detail_cause" value="<?php echo $detail_cause; ?>" placeholder="Entrer Details" />
                                        </div>
                                    ...
                                    while ($row=mysqli_fetch_array($result)):
                                     ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['detail_cause']; ?></td>   
                                            <td>
                                                <a href="cause.php?edit=<?php echo $row['id_cause'] ;?>" class="btn btn-info">Edit</a>
                                                <a href="process_cause.php?delete= <?php echo $row['id_cause']; ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                    </tbody>
