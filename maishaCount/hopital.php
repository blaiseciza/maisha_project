               ...
               <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <form role="form" action="process_hop.php" method="POST">
                                    <input type="hidden" name="id_update" value="<?php echo $id_update; ?>">
                                        
                                        <div class="form-group">
                                            <input class="form-control" name="nom_hop" value="<?php echo $nom_hop; ?>" placeholder="Entrer le nom de l'hopital" />
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" name="adresse_hop" value="<?php echo $adresse_hop; ?>" placeholder="Entrer l'adresse de l'hopital" />
                                        </div>
                                    ...
                                    while ($row=mysqli_fetch_array($result)):
                                     ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><?php echo $row['adresse_hop']; ?></td>   
                                            <td>
                                                <a href="hopital.php?edit=<?php echo $row['id_hop'] ;?>" class="btn btn-info">Edit</a>
                                                <a href="process_hop.php?delete= <?php echo $row['id_hop']; ?>" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                    </tbody>
